...
4. **Submit to Cursor Marketplace:**
   ...
   - Fill in required information:
     ...
     - Description: React/Next.js MongoDB code generation via J2Code API
...
3. **Fill in Plugin Details:**
   - Plugin Name: `GenBusApp React NextJS MongoDB`
   - Type: `MCP Server`
   - Description: Generates production-ready React/Next.js MongoDB applications from JSON schemas
   - Keywords: react, nextjs, mongodb, code-generation, business-app, j2code
   - Category: Developer Tools / Code Generation

4. **Configure Access:**
   - npm Package Name: `mcp-j2code-reactnextjs-mongodb`
   - Version: Latest
