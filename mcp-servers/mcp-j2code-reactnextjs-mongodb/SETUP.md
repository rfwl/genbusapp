# Setup Guide - MCP J2Code React NextJS MongoDB
...
4. Verify in Claude:
   ...
   - You should see "j2code-reactnextjs-mongodb" listed
...
```
User: Generate a React/NextJS MongoDB app for managing employees.
Here's the schema:
{
  "id": "string",
  "firstName": "string",
...
{
  "env": {
    "J2CODE_API_URL": "https://your-custom-api.example.com/api/j2code/reactnextjs-mongodb"
  }
}
```
...
```bash
npm uninstall -g mcp-j2code-reactnextjs-mongodb
```

### Remove from Claude/Cursor:
Edit your configuration file and remove the `j2code-reactnextjs-mongodb` entry.
...
**Enjoy generating production-ready React/NextJS MongoDB applications!** 🚀
