/* Copyright (c) 2025 j2code.app - Licensed under the MIT License (see LICENSE file for details) */
  ...
  @Component({
    selector: "contact-child-editor-form", 
templateUrl: './contact-child-editor-form.component.html', 

styleUrls: ['./contact-child-editor-form.component.scss'] 

}) 

    export class ContactChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Contact', str, 'modal-xl')
    }
...
get Mobile() { return this.editorForm.get('Mobile')  }
get Phone() { return this.editorForm.get('Phone')  }
get Email() { return this.editorForm.get('Email')  }
get Web() { return this.editorForm.get('Web')  }
