/* Copyright (c) 2025 j2code.app - Licensed under the MIT License (see LICENSE file for details) */
  ...
  @Component({
    selector: "contact-child-editor-ptable",

templateUrl: './contact-child-editor-ptable.component.html', 

styleUrls: ['./contact-child-editor-ptable.component.scss'] 

}) 

  export class ContactChildEditorPTableComponent implements OnInit {
