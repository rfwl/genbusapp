/* Copyright (c) 2025 j2code.app - Licensed under the MIT License (see LICENSE file for details) */
  ...
  import { ContactChildEditorFormComponent } from '../editor-form/contact-child-editor-form.component'



  @Component({
    selector: "contact-child-editor-aggrid", 
templateUrl: './contact-child-editor-aggrid.component.html', 

styleUrls: ['./contact-child-editor-aggrid.component.scss'] 

}) 

  export class ContactChildEditorAgGridComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'Contacts', str, 'modal-xl')
    }
...
{ field: "Mobile", tooltipField:  "Mobile", headerName: "Mobile", flex: 1 }, 
{ field: "Phone", tooltipField:  "Phone", headerName: "Phone", flex: 1 }, 
{ field: "Email", tooltipField:  "Email", headerName: "Email", flex: 1 }, 
{ field: "Web", tooltipField:  "Web", headerName: "Web", flex: 1 }, 
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      let modalRef = this.modalService.show(ContactChildEditorFormComponent, config)
