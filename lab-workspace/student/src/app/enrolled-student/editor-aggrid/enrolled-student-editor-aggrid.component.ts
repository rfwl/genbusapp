...
import { ContactChildEditorFormComponent } from "../contact/editor-form/contact-child-editor-form.component";
  ...
  @Component({
    selector: "enrolled-student-editor-aggrid", 
templateUrl: './enrolled-student-editor-aggrid.component.html', 

styleUrls: ['./enrolled-student-editor-aggrid.component.scss'] 

}) 

  export class EnrolledStudentEditorAgGridComponent implements OnInit {
...

{
  ...
  cellRendererParams: {
    ...
    showCreateForm(field: string, rowIndex: number = undefined) {
      ...
      EnrolledStudent.topComponentType = Enum_EditorComponent_Type.EditorAgGrid
