/* Copyright (c) 2025 j2code.app - Licensed under the MIT License (see LICENSE file for details) */
  ...
  @Component({
    selector: "student-address-record-child-editor-ptable",

templateUrl: './student-address-record-child-editor-ptable.component.html', 

styleUrls: ['./student-address-record-child-editor-ptable.component.scss'] 

}) 

  export class StudentAddressRecordChildEditorPTableComponent implements OnInit {
