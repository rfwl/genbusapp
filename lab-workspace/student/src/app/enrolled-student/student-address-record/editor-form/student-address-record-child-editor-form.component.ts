/* Copyright (c) 2025 j2code.app - Licensed under the MIT License (see LICENSE file for details) */
  ...
  import { EnrolledStudent, EnumSelectorOptionSource, Enum_EditorComponent_Type } from '../../enrolled-student.model'
  ...
  @Component({
    selector: "student-address-record-child-editor-form", 
templateUrl: './student-address-record-child-editor-form.component.html', 

styleUrls: ['./student-address-record-child-editor-form.component.scss'] 

}) 

    export class StudentAddressRecordChildEditorFormComponent implements OnInit {
    ...
    outputJsonString(){
      ...
      show_CodeOutput_Modal(this.modalService, 'StudentAddressRecord', str, 'modal-xl')
    }
...
get AddressLine1() { return this.editorForm.get('AddressLine1')  }
get AddressLine2() { return this.editorForm.get('AddressLine2')  }
get Suburb() { return this.editorForm.get('Suburb')  }
get State() { return this.editorForm.get('State')  }
get Postcode() { return this.editorForm.get('Postcode')  }
get Country() { return this.editorForm.get('Country')  }
